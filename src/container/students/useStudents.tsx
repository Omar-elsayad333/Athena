    ...
    const updateStudents = () => {
        if(selectedLevel.id) {
            ...
            if(yearIndex !== -1) {
                ...
                const levelIndex = originalYears[yearIndex].levels.findIndex((x: any) => x.teacherCourseLevelId == selectedLevel.id)

                if(levelIndex !== -1) {
                    loopForStudents: for(let student of originalYears[yearIndex].levels[levelIndex].students) {
                        setStudents( students => 
                            [
                                ...students,
                                student
