...
import { signUpHandler } from 'handlers/useTokenHandlers'
import { URL_LEVELS, URL_STUDENTS } from 'constant/urls'
...
const useStudentSignUp = () => {
    ...
    const [confirmPassword, setConfirmPassword] =
        useState<InputPasswordProps>(passwordInitialValues)
    ...
    const validation = () => {
        ...
        if (firstName.length == 0) {
            ...
            setFirstName((firstName) => ({
                ...firstName,
                error: true,
                helperText: 'يجب ادخال الأسم الأول',
            }))
        }
        ...
        if (lastName.length == 0) {
            ...
            setLastName((lastName) => ({
                ...lastName,
                error: true,
                helperText: 'يجب ادخال الأسم الأخير',
            }))
        }
        ...
        if (middleName.length == 0) {
            ...
            setMiddleName((middleName) => ({
                ...middleName,
                error: true,
                helperText: 'يجب ادخال الأسم الأوسط',
            }))
        }
        ...
        if (address.length == 0) {
            ...
            setAddress((address) => ({
                ...address,
                error: true,
                helperText: 'يجب أدخال عنوانك بالكامل',
            }))
        }
        ...
        if (email.length == 0) {
            ...
            setEmail((email) => ({
                ...email,
                error: true,
                helperText: 'يجب أدخال البريد الألكتروني الخاص بك',
            }))
        }
        ...
        if (phoneNumber.length == 0) {
            ...
            setPhoneNumber((phoneNumber) => ({
                ...phoneNumber,
                error: true,
                helperText: 'يجب أدخال رقم الهاتف الخاص بك',
            }))
        }
        ...
        if (homePhone.length == 0) {
            ...
            setHomePhone((homePhone) => ({
                ...homePhone,
                error: true,
                helperText: 'يجب أدخال رقم الهاتف المنزلي',
            }))
        }
        ...
        if (school.length == 0) {
            ...
            setSchool((school) => ({
                ...school,
                error: true,
                helperText: 'يجب ادخال المدرسه الخاصه بك',
            }))
        }
        ...
        if (!classification.id) {
            ...
            setClassification((classification) => ({
                ...classification,
                error: true,
                helperText: 'يجب اختيار الشعبه العلميه',
            }))
        }
        ...
        if (parentName.length == 0) {
            ...
            setParentName((parentName) => ({
                ...parentName,
                error: true,
                helperText: 'يجب ادخال اسم ولي الأمر',
            }))
        }
        ...
        if (parentJob.length == 0) {
            ...
            setParentJop((parentJob) => ({
                ...parentJob,
                error: true,
                helperText: 'يجب ادخال وظيفة ولي الأمر',
            }))
        }
        ...
        if (parentPhone.length == 0) {
            ...
            setParentPhone((parentPhone) => ({
                ...parentPhone,
                error: true,
                helperText: 'يجب ادخال رقم هاتف ولي الأمر',
            }))
        }
        ...
        if (password.length == 0) {
            ...
            setPassword((password) => ({
                ...password,
                error: true,
                helperText: 'كلمة السر لا يجب ان تقل عن 8 احرف',
            }))
            ...
            setPassword((password) => ({
                ...password,
                error: true,
                helperText: 'يجب ادخال كلمة السر',
            }))
        }
        ...
        if (confirmPassword.length == 0) {
            ...
            setConfirmPassword((confirmPassword) => ({
                ...confirmPassword,
                error: true,
                helperText: 'يجب ادخال كلمة السر مره اخري',
            }))
            ...
            setConfirmPassword((confirmPassword) => ({
                ...confirmPassword,
                error: true,
                helperText: 'يجب أدخال كلمة السر الصحيحه',
            }))
        }
        ...
        if (!ageCheck.state) {
            ...
            setAgeCheck({
                ...ageCheck,
                error: true,
                helperText: 'يجب الموافقه علي سياسة الخصوصيه وشروط الخدمه',
            })
        }
