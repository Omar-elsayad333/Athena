...
import useEditProfile from 'container/Profile/useEditProfile'
import EditProfileC from 'components/Teacher/Profile/EditProfile'
...
const Profile: NextPage = () => {
    ...
    const { data, states, actions } = useEditProfile()
        ...
        <Box sx={pageStructureStyle.root}>
            ...
            {states.loading ? (
                ...
                <Box sx={pageStructureStyle.container}>
                    ...
                    <EditProfileC states={states} actions={actions} data={data.pageData} />
                </Box>
            )}
