...
const AddHeadquarter: NextPage = () => {
    ...
    const { states, actions, dialogs } = useAddHeadquarter()
        ...
        <Box sx={style.root}>
            ...
            {states.loading ? (
                ...
                <Box sx={style.container}>
                    <PageTitle content="اضافة مقر جديد">
                        <svg
                            width="35"
                            height="35"
                            viewBox="0 0 16 25"
                    ...
                    <AddHeadquarterC states={states} actions={actions} dialogs={dialogs} />
                </Box>
            )}
...
export default withAuth(AddHeadquarter)
