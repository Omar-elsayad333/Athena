...
import TeacherExamsLayer from 'components/BigImages/TeacherExamsLayer'
            ...
            {states.loading ? (
                ...
                <Box sx={style.container}>
                    <Box sx={style.titleContainer}>
                        <PageTitle content="جميع الامتحانات المقررة">
                            <svg
                                width="25"
                                height="25"
                        ...
                        <Box sx={style.pageLayer}>
                            <TeacherExamsLayer />
                        </Box>
                    </Box>
                    <ExamsC data={data} states={states} actions={actions} />
                </Box>
            )}
