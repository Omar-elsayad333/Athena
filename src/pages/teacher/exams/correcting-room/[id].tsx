...
import useCorrectingRoom from 'container/exams/useCorrectingRoom'
import DesktopNavbar from 'components/Layout/DesktopNavbar'
import CorrectingRoomC from 'components/Teacher/Exams/CorrectingRoom'
...
const CorrectingRoom: NextPage = () => {
    ...
    const { data, states, actions } = useCorrectingRoom()
                    ...
                    <Box sx={style.header}>
                        ...
                        <Box sx={style.examNameBox}>
                            <Typography variant="h4" color={'primary'} fontWeight={700}>
                                {data.examData.examName}
                            </Typography>
                        </Box>
                    </Box>
                    <CorrectingRoomC data={data} states={states} actions={actions} />
                </Box>
            )}
...
export default withAuth(CorrectingRoom)
