...
const MyBigInputWithImage: React.FC<Props> = ({type, placeholder, helperText, error, onChange, value, name, addImage, indexes}) => {
                    ...
                    endAdornment: (
                        <InputAdornment position="start">
                            <IconButton component="label">
                                ...
                                />
                                <svg width="25" height="25" viewBox="0 0 20 20" fill={mainColors.primary.main} xmlns="http://www.w3.org/2000/svg">
...
export default MyBigInputWithImage;