...
const HeadquarterC: React.FC<Props> = ({ data }) => {
    ...
    return (
        <Box sx={style.container}>
            ...
            <DataCard data={data.headquarterData.phones[0].phone} title='تليفون 1' />
            {
                data.headquarterData.phones[1] &&
                <DataCard data={data.headquarterData.phones[1].phone} title='تليفون 2' />
            }
            {
                data.headquarterData.phones[2] &&
                <DataCard data={data.headquarterData.phones[2].phone} title='تليفون 3' />
            }
