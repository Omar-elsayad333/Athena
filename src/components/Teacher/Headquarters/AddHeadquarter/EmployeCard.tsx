    ...
    return (
        <Box sx={style.root}>
            ...
            <svg width="10" height="10" viewBox="0 0 10 10" stroke={mainColors.primary.main} fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.28 1L1 9.28" stroke="inherit" stroke-width="1.38" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M1 1L9.28 9.28" stroke="inherit" stroke-width="1.38" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            </Box>
            <Box sx={style.avatar}>
