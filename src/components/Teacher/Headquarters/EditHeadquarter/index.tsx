...
type Props = {
    ...
    dataHandlers: any;
    submit: Function;
    deleteHeadquarter: Function;
}

const EditHeadquarterC: React.FC<Props> = ({oldData, data, dataHandlers, thirdPhone, submit, deleteHeadquarter}) => {
        ...
        <Box sx={style.container}>
            ...
            <Box sx={style.buttonsContainer}>
                <Box sx={style.submitButton}>
                    <MyButton content='حفظ التعديلات' onClick={submit} />
                </Box>
                <Box sx={style.submitButton}>
                    <MyButtonError content='حذف المجموعة' onClick={deleteHeadquarter} />
                </Box>
            </Box>
        </Box>
    );
