            ...
            {data.originalData.phones && (
                <Box sx={style.inputContainer}>
                    ...
                    <MyInput
                        ...
                        placeholder={
                            data.originalData.phones[0]
                                ? data.originalData.phones[0].phone
                                : 'رقم الهاتف'
                        }
                    />
                </Box>
            ...
            {data.originalData.phones && (
                <Box sx={style.inputContainer}>
                    ...
                    <MyInput
                        ...
                        placeholder={
                            data.originalData.phones[1]
                                ? data.originalData.phones[1].phone
                                : 'رقم الهاتف'
                        }
                    />
                </Box>
                ...
                {states.thirdPhoneState ? (
                    <Box sx={style.thirdPhoneContainer}>
                        <MyInput
                            ...
                            placeholder={
                                data.originalData.phones[2]
                                    ? data.originalData.phones[2].phone
                                    : 'رقم الهاتف'
                            }
                        />
                        <svg
