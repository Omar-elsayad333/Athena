                ...
                <Box sx={style.controles}>
                    ...
                    <Box sx={style.showActionsContainer}>
                        ...
                        >
                            ...
                            />
                            <path
                                d="M25.4667 17.4209H11.1132C10.4984 17.4209 10 17.8771 10 18.4398V18.5699C10 19.1326 10.4984 19.5887 11.1132 19.5887H25.4667C26.0815 19.5887 26.58 19.1326 26.58 18.5699V18.4398C26.58 17.8771 26.0815 17.4209 25.4667 17.4209Z"
                                fill="inherit"
                            />
                            <path
                                d="M25.4667 22.8389H11.1132C10.4984 22.8389 10 23.295 10 23.8578V23.9878C10 24.5505 10.4984 25.0067 11.1132 25.0067H25.4667C26.0815 25.0067 26.58 24.5505 26.58 23.9878V23.8578C26.58 23.295 26.0815 22.8389 25.4667 22.8389Z"
                                fill="inherit"
                            />
                            <path
                                d="M25.4667 12H11.1132C10.4984 12 10 12.4562 10 13.0189V13.149C10 13.7117 10.4984 14.1678 11.1132 14.1678H25.4667C26.0815 14.1678 26.58 13.7117 26.58 13.149V13.0189C26.58 12.4562 26.0815 12 25.4667 12Z"
                                fill="inherit"
                            />
                        </svg>
                        <svg
