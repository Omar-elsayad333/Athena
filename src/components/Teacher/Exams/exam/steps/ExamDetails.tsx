...
const ExamDetails: React.FC<Props> = ({ data, states, actions }) => {
    ...
    return (
        <Box sx={style.container}>
            <Box sx={style.formContainer}>
                {data.examTypes && data.examTypes.length > 0 && (
                    <MyRadioGroup
                ...
                <Box sx={style.inputsContainer}>
                    <Box sx={style.inputWithLabel}>
                        ...
                        <MyInput
                            placeholder={data.examDetails.name}
                ...
                <Button
                    variant="contained"
                    color={'primary'}
                    onClick={() => actions.submitBasicData()}
                >
                ...
                {states.examReady && (
                    <Box sx={style.examNameCard}>
                        ...
                        {!states.spcialExam ? (
                            <svg
                                onClick={() => actions.spcialExamHandler()}
                                width="39"
                                height="39"
                                viewBox="0 0 39 39"
