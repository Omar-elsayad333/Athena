...
const ExamCard: React.FC<Props> = ({ states }) => {
    ...
    return (
        <Link href={`${Routes.teacherExam}${states.examData.id}`}>
            <Box sx={style.examCard}>
                <Box sx={style.cardTitle}>
                    <Typography
                        ...
                        overflow={'hidden'}
                    >
                        {states.examData.name}
                    </Typography>
                    {states.examData.isPrime ? (
                        <svg
                            width="39"
                            height="39"
                            viewBox="0 0 39 39"
                ...
                <Box sx={style.cardBody}>
                    <Typography variant="h5" color={mainColors.primary.main} fontWeight={700}>
                        {states.examData.levelName}
                    </Typography>
                </Box>
                <Box sx={style.cardFooter}>
                    {states.examData.state == 'Upcoming' && (
                    ...
                    {states.examData.state == 'Finished' && (
                        <Box sx={style.stateBox}>
                            <svg
                                width="18"
                                height="18"
                    ...
                    {states.examData.state == 'Correcting' && (
                        <Box sx={style.stateBox}>
                            <svg
                                width="19"
                                height="18"
