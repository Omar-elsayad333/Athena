...
import ShowAndEditQuestion from '../ShowAndEditQuestion'
...
const ShowAndEditSection: React.FC<Props> = ({ data, actions }) => {
                            ...
                            <Box sx={style.cardNameActions}>
                                {!section.isPrime ? (
                                    <svg
                                        onClick={
                                            section.openToEdit
                                                ? () => actions.sectionPrimeHandler(index)
                                                : () => {}
                                        }
                                        width="39"
                                        height="39"
                                ...
                                {!section.openToEdit ? (
                                    <MyIconButton
                                        ...
                                        event={() => actions.openSectionToEdit(index)}
                                    />
                                ) : (
                                    <MyIconButton
...
export default ShowAndEditSection
