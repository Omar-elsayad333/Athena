                    ...
                    <Box sx={style.questionContainer} key={index}>
                        <Box sx={style.cardName}>
                            ...
                            <Box sx={style.cardActions}>
                                {
                                    !question.isPrime ?
                                    <svg onClick={() => actions.primeQuestion(parentIndex, index)} width="30" height="30" viewBox="0 0 39 39" fill={mainColors.primary.main} xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <svg onClick={() => actions.notPrimeQuestion(parentIndex, index)} width="30" height="30" viewBox="0 0 39 39" fill={mainColors.warning.main} xmlns="http://www.w3.org/2000/svg">
                                ...
                                {
                                    index > 1 &&
                                    <svg onClick={() => actions.deleteQuetion({parent: parentIndex, child:index})} width="19" height="19" viewBox="0 0 19 19" fill="none" stroke={mainColors.primary.main} xmlns="http://www.w3.org/2000/svg">
                                        <path d="M17.28 2L2 17.28" stroke="inherit" stroke-width="3.38" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M2 2L17.28 17.28" stroke="inherit" stroke-width="3.38" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>      
                                }
                            </Box>
                        </Box>
