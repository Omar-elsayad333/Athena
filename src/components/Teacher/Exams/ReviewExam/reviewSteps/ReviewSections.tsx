...
import MyButtonWithIcon from 'components/Buttons/MyButtonWithIcon';
...
const ReviewSections: React.FC<Props> = ({ data, index, actions}) => {
                ...
                <Box key={index} sx={style.cardName}>   
                    ...
                    <Box sx={style.cardNameActions}>
                        ...
                        }
                        {
                            ...
                            <MyButtonWithIcon 
                                content='تعديل'
                                onClick={() => actions.openSectionToEdit(index)}
                                icon={
