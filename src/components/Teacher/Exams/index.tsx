                        ...
                        <Link key={exam.id} href={`${Routes.teacherExam}${exam.id}`}>
                            <Box sx={style.examCard}>
                                <Box sx={style.cardTitle}>
                                    ...
                                    {
                                        exam.isPrime ?
                                        <svg width="39" height="39" viewBox="0 0 39 39" fill={mainColors.warning.main} xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <svg width="39" height="39" viewBox="0 0 39 39" fill={mainColors.primary.main} xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Box sx={style.cardBody}>
                                    <Typography variant="h5" color={mainColors.primary.main} fontWeight={700}>
                                        {exam.level}
                                    </Typography>
                                </Box>
                                <Box sx={style.cardFooter}>
                                    {
                                        ...
                                        <Box sx={style.stateBox}>
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill={mainColors.primary.main} xmlns="http://www.w3.org/2000/svg">
                                                <path d="M8.75 0C3.92875 0 0 3.92875 0 8.75C0 13.5712 3.92875 17.5 8.75 17.5C13.5712 17.5 17.5 13.5712 17.5 8.75C17.5 3.92875 13.5712 0 8.75 0ZM12.5563 11.8737C12.4338 12.0837 12.215 12.1975 11.9875 12.1975C11.8737 12.1975 11.76 12.1713 11.655 12.1012L8.9425 10.4825C8.26875 10.08 7.77 9.19625 7.77 8.4175V4.83C7.77 4.47125 8.0675 4.17375 8.42625 4.17375C8.785 4.17375 9.0825 4.47125 9.0825 4.83V8.4175C9.0825 8.7325 9.345 9.19625 9.61625 9.35375L12.3288 10.9725C12.6438 11.1562 12.7488 11.5588 12.5563 11.8737Z" fill="inherit"/>
                                            </svg>
                                            <Typography variant="h6" color={mainColors.primary.main} fontWeight={700}>
                                                معلق
                                            </Typography>
                                        </Box>
                                    }
                                    {
                                        ...
                                        <Box sx={style.stateBox}>
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M8.75 0C3.92875 0 0 3.92875 0 8.75C0 13.5712 3.92875 17.5 8.75 17.5C13.5712 17.5 17.5 13.5712 17.5 8.75C17.5 3.92875 13.5712 0 8.75 0ZM12.9325 6.7375L7.97125 11.6987C7.84875 11.8212 7.6825 11.8913 7.5075 11.8913C7.3325 11.8913 7.16625 11.8212 7.04375 11.6987L4.5675 9.2225C4.31375 8.96875 4.31375 8.54875 4.5675 8.295C4.82125 8.04125 5.24125 8.04125 5.495 8.295L7.5075 10.3075L12.005 5.81C12.2587 5.55625 12.6788 5.55625 12.9325 5.81C13.1863 6.06375 13.1863 6.475 12.9325 6.7375Z" fill="#29D277"/>
                                            </svg>     
                                            <Typography variant="h6" color={mainColors.success.main} fontWeight={700}>
                                                تم تصحيحه
                                            </Typography>                               
                                        </Box>
                                    }
                                    {
                                        ...
                                        <Box sx={style.stateBox}>
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4" d="M8.75 17.7318C13.5825 17.7318 17.5 13.7624 17.5 8.8659C17.5 3.9694 13.5825 0 8.75 0C3.91752 0 0 3.9694 0 8.8659C0 13.7624 3.91752 17.7318 8.75 17.7318Z" fill="#29D277"/>
                                                <path d="M8.76959 12.6187C10.8138 12.6187 12.4708 10.9397 12.4708 8.86842C12.4708 6.79722 10.8138 5.11816 8.76959 5.11816C6.72547 5.11816 5.06836 6.79722 5.06836 8.86842C5.06836 10.9397 6.72547 12.6187 8.76959 12.6187Z" fill="#29D277"/>
                                            </svg>
                                            <Typography variant="h6" color={mainColors.success.main} fontWeight={700}>
                                                نشط الأن
                                            </Typography>
                                    ...
                                    {
                                        exam.state == 'Correcting' &&
                                        <Box sx={style.stateBox}>
                                            <svg width="19" height="18" viewBox="0 0 19 18" fill={mainColors.primary.main} xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4" d="M8.92 17.84C13.8464 17.84 17.84 13.8463 17.84 8.92C17.84 3.99362 13.8464 0 8.92 0C3.99363 0 0 3.99362 0 8.92C0 13.8463 3.99363 17.84 8.92 17.84Z" fill="inherit"/>
                                                <path d="M17.5029 1.00061C16.1908 -0.318835 14.908 -0.348156 13.5592 1.00061L12.7309 1.8216C12.6576 1.8949 12.6356 1.99752 12.6649 2.09281C13.178 3.88872 14.6148 5.32545 16.4107 5.83857C16.4327 5.8459 16.4693 5.8459 16.4913 5.8459C16.5646 5.8459 16.6379 5.81658 16.6892 5.76527L17.5029 4.94428C18.1699 4.27723 18.4998 3.6395 18.4998 2.9871C18.4998 2.32738 18.1699 1.67499 17.5029 1.00061Z" fill="inherit"/>
                                                <path d="M15.1905 6.44151C14.9926 6.34622 14.802 6.25092 14.6261 6.14097C14.4795 6.05304 14.3328 5.95774 14.1936 5.85512C14.0763 5.78182 13.9443 5.67186 13.8124 5.56191C13.7977 5.55458 13.7538 5.51793 13.6951 5.45929C13.4679 5.27603 13.226 5.0268 12.9987 4.75558C12.9841 4.74092 12.9401 4.69694 12.9035 4.63097C12.8302 4.55033 12.7202 4.41106 12.6249 4.25712C12.5443 4.1545 12.449 4.0079 12.361 3.85396C12.2511 3.67071 12.1558 3.48745 12.0678 3.29686C11.9725 3.09162 11.8992 2.90103 11.8332 2.71777L7.88958 6.66142C7.63302 6.91797 7.38379 7.40177 7.33248 7.76095L7.01728 9.94537C6.95131 10.4072 7.07592 10.8397 7.3618 11.1255C7.6037 11.3674 7.93356 11.492 8.30007 11.492C8.38071 11.492 8.46134 11.4847 8.54197 11.4774L10.719 11.1695C11.0782 11.1182 11.562 10.8763 11.8186 10.6124L15.7622 6.66875C15.579 6.6101 15.3957 6.52947 15.1905 6.44151Z" fill="inherit"/>
                                            </svg>
                                            <Typography variant="h6" color={mainColors.primary.main} fontWeight={700}>
                                                قيد التصحيح
                                            </Typography>
                                    ...
                                    <Typography variant="h6" color={mainColors.primary.main} fontWeight={700}>
                                        {`تاريخ الأنشاء : ${convertDateToShortDateNoAwait(exam.createdOn)}`}
                                    </Typography>
                                </Box>
                            </Box>
                        </Link>
